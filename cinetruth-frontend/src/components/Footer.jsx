  ...
  <footer id="equipo" className="bg-ink py-14 text-paper">
    <div className="mx-auto max-w-7xl px-5 md:px-8">
      <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
        ...
        <div><p className="font-mono text-xs font-bold uppercase tracking-[.2em] text-electric">La redacción</p><ul className="mt-4 space-y-2 font-semibold">{TEAM.map((name) => <li key={name}>💥 {name}</li>)}</ul></div>
      </div>
